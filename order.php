...
<table>
 ...
 <tr>
  <td>Last Name: </td>
  <td> <input type="text" name="last_name" placeholder="Surname" required></td>
 </tr>
 <tr>
  <td>Address: </td>
 ...
 <tr>
  <td>Enter description of product you want to buy: </td>
  <td> <input type="text" name="email" required></td>
 </tr>
 <tr>
  <td>Birthday: </td>
  <td> <input type="text" name="birthday" placeholder="dd/mm e.g 30/10"></td>
 </tr>
